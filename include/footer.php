        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    ...
                    <ul class="footer-links">
                        <li><a href="service.php">Blood Tests</a></li>
                        <li><a href="service.php">Neurological Tests</a></li>
                        <li><a href="service.php">Cardiac Tests</a></li>
                        <li><a href="service.php">Pulmonary Tests</a></li>
                        <li><a href="service.php">Sleep Studies</a></li>
                    </ul>
                </div>
                <div class="col-md-6 col-lg-3 mb-4">
